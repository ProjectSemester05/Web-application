...
const NewCatalogueCard = ({ empty, addCatalogue, pUUID }) => {
  const { isOpen, onOpen, onClose } = useDisclosure();

  return (
    <>
      {empty ? (
        <EmptyNewCatalogueCard onOpen={onOpen} pUUID={pUUID}/>
      ) : (
        <ExistingNewCatalogueCard onOpen={onOpen} />
      )}
...
const ExistingNewCatalogueCard = ({ onOpen }) => {
  return (
    <Flex
      mt="0"
